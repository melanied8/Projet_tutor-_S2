	...
	<body>
		...
		<div class="wrapper">
			...
			<ul class="nav-list">
				...
				<?php
				require('processDisplayList.php')
				?>
					
				<li class="new-list"><img class="plus" src="./assets/plus.svg"><a href="<?= route('/FormulaireAjoutDeListeExample') ?>">Nouvelle List</a></li>
				<!--j'ajoute ca pour testé les codes PHP en attendent solution pour JS-->
				<li class="new-list"><img class="plus" src="./assets/plus.svg"><a href="listDetails.php">listDetails</a></li>
				
			</ul>
			
			<div class = "settings_and_deco">
			<img src="./assets/settings.svg">
			<a href="<?= route('/settings') ?>">Paramètres</a> <!-- je sais pas pk qd je met le router ça m'envoie sur un .html -->
